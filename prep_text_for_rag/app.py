...
# Create the vector embeddings for the Healthcare provider's bio
# open ai is what converts the natural text to vector embedding before it is stored in the vector database in neo4j
# kg.query(
#     """
