...
res = kg.query(cypher)
print(
    f"There are {res[0]['numberOfProviders']} Healthcare Providers in this graph.")
...
RETURN s.name as Specialization
"""
res = kg.query(cypher)
print("Specializations of HealthCare Providers")
for r in res:
    print(r["Specialization"])
